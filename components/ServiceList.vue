<template>
  <div>
    <h2 class="text-5xl mb-4 text-gray-900 text-center">Бухгалтерские услуги</h2> 
    <ul class="list-none">
...
data (){
    return {
        ...
        accountingServices : [
        {
            ...
            'show' : false,
            'svg' : '<svg width="64px" height="64px" viewBox="-2.4 -2.4 28.80 28.80" id="chart-column-grow" xmlns="http://www.w3.org/2000/svg" class="icon multi-color" fill="#ffffff" stroke="#ffffff" transform="rotate(0)"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round" stroke="#CCCCCC" stroke-width="0.048"></g><g id="SVGRepo_iconCarrier"><title style="stroke-width: 2;">chart column grow</title><path id="tertiary-fill" d="M6,21H3V17H6Zm8-6H11v6h3Zm8-4H19V21h3Z" style="fill: #19bb16; stroke-width: 2;"></path><path id="primary-stroke" d="M6,21H3V17H6Zm8-6H11v6h3Zm8-4H19V21h3Z" style="fill: none; stroke: #0852c9; stroke-linecap: round; stroke-linejoin: round; stroke-width: 2;"></path><path id="secondary-stroke" d="M20,3c-4,7-13,9-17,9M21,7,20,3H16" style="fill: none; stroke: #20c570; stroke-linecap: round; stroke-linejoin: round; stroke-width: 2;"></path></g></svg>'
        },
        {
            'number' : 2,
            'title' : 'Услуга 2',
